...
func grpcLoggingOpts() []logging.Option {
...
func UnaryServerInterceptorLogger() grpc.UnaryServerInterceptor {
	return logging.UnaryServerInterceptor(interceptorLogger(), grpcLoggingOpts()...)
}

func StreamServerInterceptorLogger() grpc.StreamServerInterceptor {
	return logging.StreamServerInterceptor(interceptorLogger(), grpcLoggingOpts()...)
}
